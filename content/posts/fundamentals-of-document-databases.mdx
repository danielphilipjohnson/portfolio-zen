...
tableOfContents:
  ...
  - { id: "document-database-the-house-of-data", title: "Document Database: The House of Data", level: 2 }
  - { id: "document-oriented-structure-organizing-data", title: "Document-Oriented Structure: Organizing Data", level: 2 }
  - { id: "primary-fields-and-standard-fields-defining-document-structure", title: "Primary Fields and Standard Fields: Defining Document Structure", level: 2 }
  - { id: "value-types-diverse-data-representation", title: "Value Types: Diverse Data Representation", level: 2 }
  - { id: "key-terminology-understanding-the-basics", title: "Key Terminology: Understanding the Basics", level: 2 }
