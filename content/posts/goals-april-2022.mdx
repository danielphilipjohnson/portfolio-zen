...
tableOfContents:
  - id: "revamp-my-website"
    title: "Revamp my website"
    level: 2
  - id: "become-a-better-developer"
    title: "Become a Better Developer"
    level: 2
  - id: "ive-created-a-reading-list"
    title: "I've Created a Reading List"
    level: 2
  - id: "build-projects"
    title: "Build Projects"
    level: 2
  - id: "improved-my-skills-with-algorithm-and-code-challenges"
    title: "Improved My Skills with Algorithm and Code Challenges"
    level: 2
  - id: "commit-to-content-creation-and-blogging-more-frequently"
    title: "Commit to Content Creation and Blogging More Frequently"
    level: 2
  - id: "continue-to-master-my-tech-stack"
    title: "Continue to Master My Tech Stack"
    level: 2
