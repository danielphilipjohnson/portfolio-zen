...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (!seoData || !seoData.title) {
    return {
      ...
      description: "Principle 5 of calm software engineering.",
      alternates: {
...
export default ZenCalmSoftwareRoutePage;

function ZenCalmSoftwareRoutePage() {
  return <ZenCalmSoftwarePrinciplePage />;
}
