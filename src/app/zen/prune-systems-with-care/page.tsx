...
export async function generateMetadata(): Promise<Metadata> {
  const seoData = getPageSEO("/zen/prune-systems-with-care");
  const canonicalUrl =
    "https://www.danielphilipjohnson.com/zen/prune-systems-with-care";
  const fallbackImage =
  ...
  if (!seoData || !seoData.title) {
    return {
      ...
      description: "Principle 3 of calm software engineering.",
      alternates: {
...
export default ZenPruningRoutePage;

function ZenPruningRoutePage() {
  return <ZenPruningPrinciplePage />;
}
