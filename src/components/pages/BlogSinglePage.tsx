...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string[] }> }) {
	...
	const mdxContent = await MDXRemote({
		source: content,
		components: {
			h1: (props) => <Text as="h1" variant="h1" className="mt-12 mb-6 text-[var(--color-stone-800)]" id={props.id || kebabCase(props.children?.toString() || '')} {...props} />,
			h2: (props) => <Text as="h2" variant="h2" className="mt-10 mb-5 text-[var(--color-stone-800)]" id={props.id || kebabCase(props.children?.toString() || '')} {...props} />,
			h3: (props) => <Text as="h3" variant="h3" className="mt-8 mb-4 text-[var(--color-stone-800)]" id={props.id || kebabCase(props.children?.toString() || '')} {...props} />,
			h4: (props) => <Text as="h4" variant="h4" className="mt-6 mb-3 text-[var(--color-stone-800)]" id={props.id || kebabCase(props.children?.toString() || '')} {...props} />,
			h5: (props) => <Text as="h5" variant="h5" className="mt-5 mb-2 text-[var(--color-stone-800)]" id={props.id || kebabCase(props.children?.toString() || '')} {...props} />,
			h6: (props) => <Text as="h6" variant="h6" className="mt-4 mb-2 text-[var(--color-stone-800)]" id={props.id || kebabCase(props.children?.toString() || '')} {...props} />,
